...
export function StatusBadge({
  ...
  const classes = {
    ...
    blue: "bg-brand-primary-light text-brand-primary ring-blue-200",
...
export function RecordCard({
  ...
  return (
    <article className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:border-slate-300 sm:p-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          {meta ? <div className="mt-1 text-sm text-slate-600">{meta}</div> : null}
        </div>
...
export function ActionSummary({
  ...
  return (
    <summary
      className={cn(
        "cursor-pointer text-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2",
        tone === "danger" ? "text-red-800" : "text-slate-800",
      )}
    >
      {children}
    </summary>
